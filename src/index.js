...
const Slack = pkg.WebClient;

const mainUrl = "https://reflect.qsc.com/api/public/v0";
const betaUrl = "https://staging.reflect.qsc.com/api/public/v0";
...
const getData = async (p) => {
  try {
    return new Promise((resolve, reject) => {
      axios.get(`${betaUrl}/${p}`, {headers: Creds.Headers})
      .catch(e => reject(e))
      .then(res => {
        resolve(res.data)
      })
